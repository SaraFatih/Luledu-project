...
public class ClientProxy extends CommonProxy{
	...
	public void registerKeyBindings() {
		...
		ClientRegistry.registerKeyBinding(KeyBindings.makeGUI);
	...
	@Override
	public void registerRenderers(EduMod ins) {
		ins.addAssignmentGUI.registerRenderers();
		ins.myKeyBind.registerRenderers();


	}
	@Override
	public void openMyGui(String assignment){
		Minecraft.getMinecraft().displayGuiScreen(new BookGui(assignment));
